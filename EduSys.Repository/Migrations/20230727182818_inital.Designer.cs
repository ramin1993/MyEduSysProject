...
namespace EduSys.Repository.Migrations
{
    ...
    [Migration("20230727182818_inital")]
            ...
            modelBuilder.Entity("EduSys.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 7, 27, 22, 28, 17, 716, DateTimeKind.Local).AddTicks(4075),
                            Name = "Computer",
                            Price = 800m,
                            Stock = 35m
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 7, 27, 22, 28, 17, 716, DateTimeKind.Local).AddTicks(4092),
                            Name = "T-Shirt",
                            Price = 50m,
                            Stock = 400m
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2023, 7, 27, 22, 28, 17, 716, DateTimeKind.Local).AddTicks(4094),
                            Name = "Cat Food",
                            Price = 25m,
                            Stock = 1000m
                        });
